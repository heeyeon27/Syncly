...
public interface NoticeRepository extends JpaRepository<Notice, Long> {
    ...
    @Query("SELECT n FROM Notice n JOIN FETCH n.author WHERE n.project = :project AND n.deletedAt IS NULL ORDER BY n.createdAt DESC")
    ...
    @Query("SELECT n FROM Notice n " +
           ...
           "WHERE pm.member.id = :memberId AND n.deletedAt IS NULL " +
           "AND n.id NOT IN (" +
